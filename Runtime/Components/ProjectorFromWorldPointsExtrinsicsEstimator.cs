/*
	...
	to find the extrinsics (position and rotation) of the projector relative to the model.
...
{
	public class ProjectorFromWorldPointsExtrinsicsEstimator : MonoBehaviour
	{
		...
		[Header("Output")]
		[SerializeField] Camera _projectorCamera = null;
		...
		void UpdateCameraTransform()
		{
			...
			_extrinsicsCalibrator.extrinsics.ApplyToTransform( _projectorCamera.transform );
